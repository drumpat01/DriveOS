...
export const bootstrapSchema = {
  ...
  properties: {
    ...
    summary: { type: "object", additionalProperties: false, required: ["placeCount", "connectionCount", "journeyCount", "totalMiles"], properties: { placeCount: integer, connectionCount: integer, journeyCount: integer, totalMiles: number } },
