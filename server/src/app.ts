...
const publicPaths = new Set(["/healthz", "/readyz", "/login", "/login.html", "/privacy", "/privacy.html", "/apple-music-soundtrack", "/private-driving-journal", "/driving-journal", "/support", "/support.html", "/terms", "/terms.html", "/robots.txt", "/sitemap.xml", "/manifest.webmanifest", "/favicon.ico"]);
