...
export async function createApp(overrides: CreateAppOverrides = {}) {
  ...
  app.get("/", async (_req, reply) => reply.sendFile("index.html")); app.get("/spotify-callback", async (_req, reply) => reply.sendFile("index.html")); app.get("/login", async (_req, reply) => reply.sendFile("login.html")); app.get("/privacy", async (_req, reply) => reply.sendFile("privacy.html")); app.get("/support", async (_req, reply) => reply.sendFile("support.html")); app.get("/wife", async (_req, reply) => reply.sendFile("wife.html"));
