...
const JS_ONLY_UPDATE = [
  ...
  'Do not publish until that update is explicitly authorized. This source requires runtime 3.0.0-preview.7; installed Build 38 uses preview.6.',
].join('\n');
...
export async function run(argv, io = {}) {
  ...
  const currentRecord = {
    platform: 'ios',
    preset: 'balanced',
    runtimeVersion: '3.0.0-preview.7',
    channel: 'v3-preview',
