...
V3 TestFlight (`eas` profile `v3-testflight`) targets this live listing
(`ascAppId` `6806502526`, bundle `com.journeydeck.recorder`). It is
TestFlight only — never App Store review submit from that stream. Never
