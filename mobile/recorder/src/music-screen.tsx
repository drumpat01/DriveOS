...
const styles = StyleSheet.create({
  ...
  panel: { borderRadius: 20, borderWidth: 1, borderColor: '#47275b', backgroundColor: colors.panel, padding: 14, overflow: 'hidden', shadowColor: '#000', shadowOpacity: 0.16, shadowRadius: 10, shadowOffset: { width: 0, height: 5 } }, cardHeader: { minHeight: 26, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginBottom: 10 }, cardTitleGroup: { flex: 1, flexDirection: 'row', alignItems: 'center', gap: 8 }, cardAccent: { width: 3, height: 17, borderRadius: 2, backgroundColor: colors.coral, shadowColor: colors.coral, shadowOpacity: 0.75, shadowRadius: 6 }, cardTitle: { flex: 1, color: colors.text, fontSize: 15, fontWeight: '900' }, cardKicker: { color: '#ff6b89', fontSize: 7, fontWeight: '900', letterSpacing: 0.7 },
