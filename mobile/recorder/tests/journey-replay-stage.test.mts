...
function harness() {
  ...
  const mocks: any = {
    ...
    './navy-frost': { NavyFrostSurface: host('NavyFrostSurface') },
    './navy-frost-policy': { NAVY_FROST: { solid: '#0B1830', tint: 'rgba(8,24,50,0.52)', edge: 'rgba(142,180,232,0.18)', ink: '#F4F1EA', muted: '#B7C2D6', accent: '#8EB4E8' } },
    './use-core-motion': { useCoreMotion: () => ({ reduceTransparency: false, reduceMotion: false }) },
