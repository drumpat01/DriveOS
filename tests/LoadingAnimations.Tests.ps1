...
Assert-True ($Loader -match 'addEventListener\("load",resolve' -and $Ignition -match 'JourneyDeckLoader\?\.ready') 'Animation timing must start after its visual stylesheet is ready.'
