...
Assert-True ($wifeHtml -match 'id="collectionsView"' -and $wifeJs -match '/api/wife/collections') 'Wife Mode shared collections are missing.'
Assert-True ($wifeHtml -notmatch '(?i)newJourneyCollection|deleteJourneyCollection|journeyCollectionForm') 'Wife Mode exposes collection editing controls.'
