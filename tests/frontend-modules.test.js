...
for(const file of ['web/core/dom.js','web/core/state.js','web/core/platform.js','web/core/api.js','web/features/drives.js','web/features/replay.js'])vm.runInContext(fs.readFileSync(path.join(root,file),'utf8'),context,{filename:file});
