...
JourneyDeck is a local-first driving journal for iPhone and iPad, with a companion Apple Watch app. Its core recorder does not require an account, a server connection, a music subscription, or a vehicle connection.

## Core review path

1. Open the app. JourneyDeck 2.0 introduces every user to **Manual Recording**; tap Start and Finish for each journey.
...
- **Location:** Core to recording an intentionally started journey. JourneyDeck 2.0 never begins a journey automatically. The iPhone records and stores the route locally first. It does not provide navigation or emergency services.
