/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc --env-file=cloudflare/.dev.vars.example --strict-vars=false cloudflare/worker-configuration.d.ts` (hash: a5b782aa9ede938ae122c455ba6ea0e5)
