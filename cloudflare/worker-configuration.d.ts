/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc --env-file=cloudflare/.dev.vars.example --strict-vars=false cloudflare/worker-configuration.d.ts` (hash: d004d90367d4720152b3a2120bd15237)
// Runtime types generated with workerd@1.20260911.1 2026-08-27 nodejs_compat
interface __BaseEnv_Env {
	PUBLIC_PLACES: R2Bucket;
	EDGE_RATE_LIMITER: RateLimit;
	LASTFM_RATE_LIMITER: RateLimit;
	SPOTIFY_RATE_LIMITER: RateLimit;
	TESSIE_RATE_LIMITER: RateLimit;
	ENVIRONMENT: string;
	EDGE_ENABLED: string;
	LASTFM_ENABLED: string;
	SPOTIFY_ENABLED: string;
	TESSIE_ENABLED: string;
	PLACES_ENABLED: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EDGE_ENABLED" | "LASTFM_ENABLED" | "SPOTIFY_ENABLED" | "TESSIE_ENABLED" | "PLACES_ENABLED" | "OVERTURE_ENABLED" | "OVERTURE_RELEASE" | "OVERTURE_CACHE_NAMESPACE" | "UPSTREAM_TIMEOUT_MS" | "NOMINATIM_USER_AGENT" | "ALLOWED_ORIGINS" | "SPOTIFY_REDIRECT_URIS">> {}
}
