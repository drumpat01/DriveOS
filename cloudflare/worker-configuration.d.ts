/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare/wrangler.jsonc --env-file=cloudflare/.dev.vars.example --strict-vars=false cloudflare/worker-configuration.d.ts` (hash: 055c3e6b7ddc89391193d810e2ccd5fe)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ENVIRONMENT" | "EDGE_ENABLED" | "LASTFM_ENABLED" | "SPOTIFY_ENABLED" | "TESSIE_ENABLED" | "PLACES_ENABLED" | "UPSTREAM_TIMEOUT_MS" | "NOMINATIM_USER_AGENT" | "ALLOWED_ORIGINS" | "SPOTIFY_REDIRECT_URIS">> {}
}
